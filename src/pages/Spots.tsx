...
export function Spots() {
  ...
  return (
    <div className="space-y-5">
      <header>
        <h1 className="text-2xl font-bold text-foam tracking-tight">
          Bali spots
        </h1>
      ...
      <div className="flex flex-wrap gap-2 items-center">
        <input
          ...
          className="input min-w-[180px] max-w-xs"
        />
        <select
          value={regionFilter ?? ""}
          onChange={(e) =>
        ...
        <button
          ...
          className={`btn ${
            favOnly
              ? "bg-sand-400/15 border border-sand-400/60 text-sand-300"
              : "btn-ghost"
          }`}
        >
          ★ Favorites
      ...
      {list.length === 0 ? (
        <div className="glass rounded-2xl p-8 text-center text-ocean-400 text-sm">
