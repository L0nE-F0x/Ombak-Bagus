...
export function Settings() {
  ...
  return (
    <div className="space-y-6 max-w-xl">
      <header>
        <h1 className="text-2xl font-bold text-foam tracking-tight">Settings</h1>
        <p className="text-sm text-ocean-400 mt-1">
          Ombak Bagus · personal Bali surf desk
        </p>
      </header>
      ...
      <section className="glass rounded-2xl p-5 space-y-3 text-sm">
        ...
        <p className="text-ocean-200 leading-relaxed">
          ...
          0.25° / 0.16°, ECMWF WAM 0.25°, Météo-France Wave (same API, independent
          models — Windguru-style cross-check)
        </p>
        <p className="text-ocean-200 leading-relaxed">
        ...
        <p className="text-ocean-200 leading-relaxed">
          <strong className="text-foam">Wind & weather</strong> — Open-Meteo
          Forecast API
        </p>
        <p className="text-ocean-200 leading-relaxed">
      ...
      <section className="glass rounded-2xl p-5 text-sm text-ocean-400">
        <p className="text-foam font-medium">Ombak Bagus v0.1.0</p>
